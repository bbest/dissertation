...
---
```{r setup_sdm, echo=FALSE, include=TRUE}
# can't seem to put this above the YAML to be able to use variables defined in make_config.R and still generate References
source('make_config.R')
```
...
---
```{r setup_siting, echo=FALSE, include=TRUE}
# can't seem to put this above the YAML to be able to use variables defined in make_config.R and still generate References
source('make_config.R')
```
...
---
```{r setup_range, echo=FALSE, include=TRUE}
# can't seem to put this above the YAML to be able to use variables defined in make_config.R and still generate References
source('make_config.R')
```
...
---
```{r setup_routing, echo=FALSE, include=TRUE}
# can't seem to put this above the YAML to be able to use variables defined in make_config.R and still generate References
source('make_config.R')
```
...
---
```{r setup_migration, echo=FALSE, include=TRUE}
# can't seem to put this above the YAML to be able to use variables defined in make_config.R and still generate References
source('make_config.R')
```
...
output: 
  html_document:
    pandoc_args: [
      "--bibliography", "dissertation.bib",
      "--csl", "csl/global-ecology-and-biogeography.csl"
    ]
---
