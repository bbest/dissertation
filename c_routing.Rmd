...
fig(
  ...
  'Ships were rerouted in Boston Harbor around hotspots of right whale observations, but in ad-hoc fashion without quantitifying the tradeoff between cost to industry and conservation gain. Source: [@ward-geiger_characterization_2005a].')
...
TODO: describe `r tbl('bc_species_industry_impacts', cite=T)`.
