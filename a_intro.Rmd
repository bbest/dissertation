...
`r fig('fig_crowder_resolving_2006', 'fig/MSP-SoCal_Crowder2006-Science.png', 'Example of complex management from Crowder et al.(2006).')`
...
Blah blah, as in `r ref('fig_crowder_resolving_2006')`.
